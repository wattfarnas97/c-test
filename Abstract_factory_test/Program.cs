...
namespace Abstract_factory_test
{
    class Program
    {
        ...
        {
            Ordinateur ordinateur;            // Stock de cartes meres et cartes graphiques    
            ...
            Console.WriteLine("Voulez-vous commander un " +            "ordinateur fixe (1) ou portable (2)?");
            ...
            carteGraphique[0].afficherDetail();
            carteMere[0].afficherDetail();
            Console.ReadKey(); 
        }
    }
}
